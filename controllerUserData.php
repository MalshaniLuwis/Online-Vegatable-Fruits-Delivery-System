...
if(isset($_POST['signup'])){
    ...
    if(count($errors) === 0){
        ...
        $status2 = "notverified";
        $insert_data = "INSERT INTO users (name, password, email, mobile, code, status2, added_on)
                        values('$name', '$encpass', '$email','$mobile', '$code', '$status2', '$added_on')";
        ...
        if($data_check){
            ...
            include('smtp/PHPMailerAutoload.php');
                ...
                $mail->SMTPSecure="tls";
                $mail->SMTPAuth=true;
                $mail->Username="nadeeshaa22@gmail.com";
                $mail->Password="nadeesha22107";
                $mail->SetFrom("nadeeshaa22@gmail.com");
